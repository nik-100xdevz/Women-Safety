          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="mt-2 space-y-2">
                  <p className="text-gray-500">
                    <span className="font-medium">General Inquiries:</span> +91 123 456 7890
                  </p>
                  <p className="text-gray-500">
                    <span className="font-medium">Emergency Support:</span> +91 987 654 3210
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <p className="mt-2 text-gray-500">
                  Our emergency support team is available 24/7 to assist you in any crisis situation.
                </p>
                <div className="mt-4">
                  <a
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            >
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3771.142587887475!2d72.85373831524585!3d19.07674898745637!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c6306644edc1%3A0x5da4ed8f8d648c69!2sMumbai%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1648191234567!5m2!1sen!2sin"
                width="100%"
                height="450"
                style={{ border: 0 }}
                allowFullScreen=""
