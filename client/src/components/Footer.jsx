...
import LogoWithout from '../assets/logoWithout.png'
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <p className="mt-4 text-sm text-gray-500">
              Empowering women with safety, support, and resources to thrive in their communities.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              <li>
                <Link to="/emergency" className="text-base text-gray-500 hover:text-pink-600">
                  Emergency Help
                </Link>
              </li>
              <li>
                <Link to="/resources" className="text-base text-gray-500 hover:text-pink-600">
                  Safety Resources
                </Link>
              </li>
              <li>
                <Link to="/community" className="text-base text-gray-500 hover:text-pink-600">
                  Community Support
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-base text-gray-500 hover:text-pink-600">
                  About Us
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              <li>
                <a href="https://dial112.mahapolice.gov.in/CitizenPortal-Maharashtra/women-safety" 
                   target="_blank" 
                   rel="noopener noreferrer"
                   className="text-base text-gray-500 hover:text-pink-600">
                  Mumbai Police Women Safety
                </a>
              </li>
              <li>
                <a href="https://services.india.gov.in/service/detail/lodge-your-complaint-with-national-commission-for-women" 
                   target="_blank" 
                   rel="noopener noreferrer"
                   className="text-base text-gray-500 hover:text-pink-600">
              ...
              <li>
                <a href="https://www.mha.gov.in/en/divisionofmha/women-safety-division" 
                   target="_blank" 
                   rel="noopener noreferrer"
                   className="text-base text-gray-500 hover:text-pink-600">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              <li>
                <a href="https://aksharacentre.org/" 
                   target="_blank" 
                   rel="noopener noreferrer"
                   className="text-base text-gray-500 hover:text-pink-600">
                  Akshara Centre
              ...
              <li>
                <a href="https://www.aartiforgirls.org/" 
                   target="_blank" 
                   rel="noopener noreferrer"
                   className="text-base text-gray-500 hover:text-pink-600">
                  Aarti for Girls
              ...
              <li>
                <a href="https://mahilaektasangh.in/" 
                   target="_blank" 
                   rel="noopener noreferrer"
                   className="text-base text-gray-500 hover:text-pink-600">
                  Mahila Ekta Sangh
        ...
        <div className="mt-8 border-t border-gray-200 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-base text-gray-400">
              © {new Date().getFullYear()} We Safe™. All Rights Reserved.
            </p>
